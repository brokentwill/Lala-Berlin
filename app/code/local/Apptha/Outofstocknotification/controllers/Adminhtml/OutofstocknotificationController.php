	...
	public function saveAction() {
		if ($data = $this->getRequest()->getPost()) {
			...
			try {
				...
				$model->save();
				Mage::getSingleton('adminhtml/session')->addSuccess(Mage::helper('outofstocknotification')->__('Item was successfully saved'));
        ...
        Mage::getSingleton('adminhtml/session')->addError(Mage::helper('outofstocknotification')->__('Unable to find item to save'));
        $this->_redirect('*/*/');
	}
