...
class HM_EasyBanner_Block_Adminhtml_Banneritem_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form
{
  protected function _prepareForm()
  {
   ...
   $fieldset->addField('title_color', 'select', array(
    'label'     => Mage::helper('easybanner')->__('Title Color'),
    'required'  => false,
    'name'      => 'title_color',
    'values'    => array(
      ...
      array(
        'value'     => 1,
        'label'     => Mage::helper('easybanner')->__('White'),
        ),

      array(
        'value'     => 2,
        'label'     => Mage::helper('easybanner')->__('Black'),
        ),
      ),
    ));
