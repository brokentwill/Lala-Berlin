...
class AW_Blog_Block_Manage_Blog_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form
{
    protected function _prepareForm()
    {
        ...
        $fieldset->addField('feature_media', 'image', array(
            'name' => 'feature_media',
            'label' => 'Cover Image',
            'title' => 'Cover Image',
            'required'  => false,
        ...
        // $fieldset->addField('feature_url', 'text', array(
        //     'name' => 'feature_url',
        //     'label' => 'Input Video Url For Timeline',
        //     'title' => 'Input Video Url For Timeline',
        //     'style' => 'width:450px;',
        //     'required'  => false,
        //     'disabled'  => $isElementDisabled,
        // ));
