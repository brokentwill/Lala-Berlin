...
class Fooman_PdfCustomiser_Helper_Data extends Fooman_EmailAttachments_Helper_Data
{
    ...
    {
        return Mage::helper('pdfcustomiser/pdf_order')->getPdfFileName(array($order->getIncrementId()),'');
    }

    public function getInvoiceAttachmentName($invoice)
    {
        return Mage::helper('pdfcustomiser/pdf_invoice')->getPdfFileName(array($invoice->getIncrementId()),'');
    }

    public function getShipmentAttachmentName($shipment)
    {
        return Mage::helper('pdfcustomiser/pdf_shipment')->getPdfFileName(array($shipment->getIncrementId()),'');
    }

    public function getCreditmemoAttachmentName($creditmemo)
    {
        return Mage::helper('pdfcustomiser/pdf_creditmemo')->getPdfFileName(array($creditmemo->getIncrementId()),'');
    }
}
