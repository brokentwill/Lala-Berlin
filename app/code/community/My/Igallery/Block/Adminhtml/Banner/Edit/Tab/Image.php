    ...
    public function getImagesJson() {
        ...
        if (is_array($_data) and sizeof($_data) > 0) {
            ...
            foreach ($_data as &$_item) {
				$_result[] = array("value_id" => $_item["image_id"], "url" => Mage::getSingleton("igallery/config")->getBaseMediaUrl() . $_item["file"], "file" => $_item["file"], "label" => $_item["label"], "image_url" => $_item["image_url"], "image_desc" => $_item["image_desc"], "image_width" => $_item["image_width"], "image_height" => $_item["image_height"], "position" => $_item["position"], "disabled" => $_item["disabled"]);
