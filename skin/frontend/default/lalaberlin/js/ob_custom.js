...
jQuery(window).load(function() {
    ...
    // if ( !isMobile() ) {
        if ( jQuery(window).width() >= 1010 ) {
            if ( jQuery('.shop-top .category-image').height() > jQuery('.shop-top .shop-sale').height() ) {
                jQuery('.shop-top .category-image').height(jQuery('.shop-top .shop-sale').height());
            } else if ( jQuery('.shop-top .category-image').height() < jQuery('.shop-top .shop-sale').height() ) {
                jQuery('.shop-top .shop-sale').height(jQuery('.shop-top .category-image').height());
            }
        };
    // };
